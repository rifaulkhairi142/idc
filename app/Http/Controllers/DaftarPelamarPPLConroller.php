...
class DaftarPelamarPPLConroller extends Controller
{
    public function index()
    {

        $daftarpelamarppl = LamaranPPL::join('lowongan_ppl_tbl', 'lowongan_ppl_tbl.id', '=', 'lamaranppl_tbl.id_lowongan_ppl')
        ...
        return Inertia::render('Admin/pages/daftarpelamarppl/DaftarPelamarPPL', ['daftarpelamarppl' => $daftarpelamarppl]);
    }
}
