...
return new class extends Migration
{
    ...
    {
        Schema::create('conversation_classroom_ppl', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('id_kelas')->references('id')->on('sekolah_tbl')->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('conversation_classroom_ppl');
    }
};
