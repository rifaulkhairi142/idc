        ...
        >
            ...
            <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
                <NavLink to="/admin/dashboard">
                    <h1 className="text-3xl font-bold text-white">IDC</h1>
                </NavLink>
                ...
                <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
                    ...
                    <div>
                        ...
                        <ul className="mb-6 flex flex-col gap-1.5">
                                        ...
                                        <React.Fragment>
                                            ...
                                            >
                                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                                    ...
                                                    <li>
                                                        <NavLink
                                                            href="/admin/mahasiswappkpm"
                                                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-white ${
                                                                (pathname ===
                                                                    "/admin/mahasiswappkpm" ||
                                                                    pathname.includes(
                                                                        "mahasiswappkpm"
                                                                    )) &&
                                                                "!text-white"
                            ...
                            <SidebarLinkGroup
                                activeCondition={
                                    pathname === "/admin/tempatkpm" ||
                                    pathname.includes("tempatkpm")
                                }
                            >
                                {(handleClick, open) => {
                                    return (
                                        <React.Fragment>
                                            ...
                                            >
                                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                                    ...
                                                    <li>
                                                        <NavLink
                                                            href="/admin/tempatkpm/pelamar/list"
                                                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-white ${
                                                                (pathname ===
                                        ...
                                        <React.Fragment>
                                            ...
                                            >
                                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                                    <li>
                                                        <NavLink
                                                            href="/admin/certificate/nilai-ppkpm"
                                                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-white ${
                                                                (pathname ===
                                        ...
                                        <React.Fragment>
                                            ...
                                            >
                                                <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                                    ...
                                                    <li>
                                                        <NavLink
                                                            href="/admin/admin-kecamatan/list"
                                                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-white ${
                                                                (pathname ===
