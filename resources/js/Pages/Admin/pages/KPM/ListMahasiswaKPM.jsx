...
const ListMahasiswaKPM = ({ daftarmahasiswakpm, flash }) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            options: {
                customBodyRender: (value) => {
                    return <p>{value?.data_mahasiswa?.prodi?.name}</p>;
                },
            },
        },
        {
                ...
                customBodyRender: (value, tableMeta) => {
                    return (
                        <p className="text-center">
                            {value?.data_mahasiswa?.nilai_supervisor_kpm}
                        </p>
                    );
                },
            },
        },
        {
            ...
            options: {
                customBodyRender: (value, tableMeta) => {
                    return (
                        <p className="text-center">
                            {value?.data_mahasiswa?.nilai_keuchik}
                        </p>
                    );
                },
            },
        ...
        <section className="main flex">
            ...
            <div className="flex w-full ml-72 flex-col">
                ...
                <div className="px-3">
                    ...
                    <MUIDataTable
                        title={"Daftar Mahasiswa KPM"}
                        data={daftarmahasiswakpm}
                        columns={columns}
                        options={options}
                    />
                </div>
...
export default ListMahasiswaKPM;
