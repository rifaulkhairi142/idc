...
export const FollowUpLamaranPPL = ({ lamaran, base_url, lownganppl }) => {
    const prv = provinsi();
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        post(`/admin/pelamarppl/followup/${lamaran.id}`);
    };
    useEffect(() => {
    ...
    return (
        <section className="main flex">
            ...
            <div className="flex ml-72 w-full flex-col">
                <Header></Header>
                <Head title={`${lamaran?.user?.name}`} />
                <div className="space"></div>
                <div className="flex flex-col w-full px-3 gap-y-3">
                    <Breadcrumbs separator={<NavigateNext fontSize="small" />}>
                        <Link href="/admin/daftarlowonganppl">Lowongan</Link>
                        <Link>Detail</Link>
                    </Breadcrumbs>
                        ...
                        <div className="w-full">
                            <table className="table-auto">
                                <tbody>
                                    ...
                                    <tr className="gap-3">
                                        <td className="text-gray-600 text-end align-top pr-2">
                                            Sekolah Yang Dilamar
                                        </td>
                                        <td className="text-gray-950 font-semibold align-top">
                                            {lamaran?.ppl?.sekolah?.name}
                                        </td>
                                    </tr>
                                    <tr className="gap-3">
                                        <td className="text-gray-600 text-end align-top pr-2">
                                    ...
                                    <tr className="gap-3">
                                        ...
                                        <td className="text-gray-950 font-semibold align-top">
                                            {lownganppl?.accepted_pelamar_count}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
...
export default FollowUpLamaranPPL;
