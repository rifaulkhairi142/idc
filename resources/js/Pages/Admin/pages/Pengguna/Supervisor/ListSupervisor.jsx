...
const ListSupervisor = ({ daftarsupervisor, flash }) => {
                ...
                <div className="px-3">
                    <div className="flex w-full  py-2 gap-x-3">
                        <Button
                            ...
                            onClick={(e) => {
                                console.log("test");
                                router.visit("/admin/tambah/supervisor");
                            }}
                        >
                            Tambah
                        </Button>
                        <Button
                            variant="contained"
                            onClick={(e) => {
                                router.visit("/admin/supervisor/import");
                            }}
                        >
                            Import
                        </Button>
