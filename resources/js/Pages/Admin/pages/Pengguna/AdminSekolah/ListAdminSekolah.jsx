...
const ListMahsiswa = ({ daftarmahasiswa, message, base_url, flash }) => {
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `${base_url}/api/admin/admin-sekolah/query?page=${currentPage}&search_key=${searchKey}`
            );
    ...
    const deleteRecords = async (id) => {
        ...
        try {
            const response = await axios.post(
                `${base_url}/api/admin/oprator-sekolah/delete/${id}`
            );
            fetchData();
    ...
    const bulkDelete = async (id) => {
        ...
        try {
            const response = await axios.post(
                `${base_url}/api/admin/oprator-sekolah/bulk-delete`
            );
            fetchData();
            console.log(response);
        } catch (err) {
    ...
    const exportExcel = async () => {
        ...
        try {
            const response = await axios.post(
                `${base_url}/api/admin/oprator-sekolah/export`,
    ...
    const generate = async () => {
        ...
        try {
            const response = await axios.post(
                `${base_url}/api/admin/admin-sekolah/generate`
            );
