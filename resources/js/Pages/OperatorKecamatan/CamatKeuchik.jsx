    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.get(
                `${base_url}/api/operator-kecamatan/data/camat-keuchik/query?page=${currentPage}&search_key=${searchKey}&id_kecamatan=${data_opt.id_kecamatan}`
            );
    ...
    const deleteRecords = async (id) => {
        ...
        try {
            const response = await axios.post(
                `${base_url}/api/operator-kecamatan/data/camat-keuchik/delete/${id}`
            );
            fetchData();
                ...
                <div className="flex w-full justify-start gap-x-2 py-2">
                    ...
                    <Button
                        ...
                        onClick={(e) => {
                            // e.preventDefault();
                            router.visit(
                                "/operator-kecamatan/data/camat-keuchik/add"
                            );
                        }}
                    >
                        Tambah
                                                    ...
                                                    <ul className="py-1 text-sm text-gray-700 dark:text-gray-200">
                                                        <li>
                                                            <a
                                                                onClick={() => {
                                                                    router.get(
                                                                        `/operator-kecamatan/data/camat-keuchik/detail/${item.id}`
                                                                    );
                                                                    setDropdownOpen(
                                                                        null
                                                                    );
